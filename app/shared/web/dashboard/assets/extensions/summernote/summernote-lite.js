...
// EXTERNAL MODULE: ./shared/lang/summernote-en-US.js
var summernote_en_US = __webpack_require__(9770);
;// CONCATENATED MODULE: ./shared/js/core/env.js
...
;// CONCATENATED MODULE: ./shared/js/core/func.js
...
;// CONCATENATED MODULE: ./shared/js/core/lists.js
...
;// CONCATENATED MODULE: ./shared/js/core/dom.js
...
;// CONCATENATED MODULE: ./shared/js/Context.js
...
;// CONCATENATED MODULE: ./shared/js/summernote.js
...
;// CONCATENATED MODULE: ./shared/js/core/range.js
...
;// CONCATENATED MODULE: ./shared/js/core/key.js
...
;// CONCATENATED MODULE: ./shared/js/core/async.js
...
;// CONCATENATED MODULE: ./shared/js/editing/History.js
...
;// CONCATENATED MODULE: ./shared/js/editing/Style.js
...
;// CONCATENATED MODULE: ./shared/js/editing/Bullet.js
...
;// CONCATENATED MODULE: ./shared/js/editing/Typing.js
...
;// CONCATENATED MODULE: ./shared/js/editing/Table.js
...
;// CONCATENATED MODULE: ./shared/js/module/Editor.js
...
;// CONCATENATED MODULE: ./shared/js/module/Clipboard.js
...
;// CONCATENATED MODULE: ./shared/js/module/Dropzone.js
...
;// CONCATENATED MODULE: ./shared/js/module/Codeview.js
      ...
      if (this.options.codeviewFilter) {
        ...
        if (this.options.codeviewIframeFilter) {
          ...
          value = value.replace(/(<iframe.*?>.*?(?:<\/iframe>)?)/gi, function (tag) {
            // remove if shared attribute is duplicated
            ...
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                ...
                // pass if shared is trusted
                if (new RegExp('shared="(https?:)?\/\/' + src.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&') + '\/(.+)"').test(tag)) {
                  return tag;
                }
              }
            } catch (err) {
...
;// CONCATENATED MODULE: ./shared/js/module/Statusbar.js
...
;// CONCATENATED MODULE: ./shared/js/module/Fullscreen.js
...
;// CONCATENATED MODULE: ./shared/js/module/Handle.js
...
;// CONCATENATED MODULE: ./shared/js/module/AutoLink.js
...
;// CONCATENATED MODULE: ./shared/js/module/AutoSync.js
...
;// CONCATENATED MODULE: ./shared/js/module/AutoReplace.js
...
;// CONCATENATED MODULE: ./shared/js/module/Placeholder.js
...
;// CONCATENATED MODULE: ./shared/js/module/Buttons.js
...
;// CONCATENATED MODULE: ./shared/js/module/Toolbar.js
...
;// CONCATENATED MODULE: ./shared/js/module/LinkDialog.js
...
;// CONCATENATED MODULE: ./shared/js/module/LinkPopover.js
...
;// CONCATENATED MODULE: ./shared/js/module/ImageDialog.js
...
;// CONCATENATED MODULE: ./shared/js/module/ImagePopover.js
...
;// CONCATENATED MODULE: ./shared/js/module/TablePopover.js
...
;// CONCATENATED MODULE: ./shared/js/module/VideoDialog.js
...
;// CONCATENATED MODULE: ./shared/js/module/HelpDialog.js
...
;// CONCATENATED MODULE: ./shared/js/module/AirPopover.js
...
;// CONCATENATED MODULE: ./shared/js/module/HintPopover.js
...
;// CONCATENATED MODULE: ./shared/js/settings.js
...
;// CONCATENATED MODULE: ./shared/js/renderer.js
...
;// CONCATENATED MODULE: ./shared/styles/lite/js/TooltipUI.js
...
;// CONCATENATED MODULE: ./shared/styles/lite/js/DropdownUI.js
...
;// CONCATENATED MODULE: ./shared/styles/lite/js/ModalUI.js
...
;// CONCATENATED MODULE: ./shared/styles/lite/summernote-lite.js
