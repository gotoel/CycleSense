...
func (senseController *SenseController) processEvents() {
	go func() {
		for event := range senseController.sensorEvents {
			...
			senseController.controller.SetBtn(goxinput.BUTTON_A, manager.Manager.Chuck.Buttons.ButtonC)
			senseController.controller.SetBtn(goxinput.BUTTON_B, manager.Manager.Chuck.Buttons.ButtonZ)

			senseController.controller.SetBtn(goxinput.BUTTON_A, manager.Manager.Chuck.Buttons.ButtonA)
			senseController.controller.SetBtn(goxinput.BUTTON_B, manager.Manager.Chuck.Buttons.ButtonB)
			...
			//senseController.controller.SetBtn(goxinput.BUTTON_LT, manager.Manager.Chuck.Triggers.TriggerLeft)
			//senseController.controller.SetBtn(goxinput.BUTTON_RT, manager.Manager.Chuck.Triggers.TriggerRight)
